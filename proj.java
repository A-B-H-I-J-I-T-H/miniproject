...
@Override 
public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus column) { 
JComponent c = (Component)baseRenderer.getTableCellRendererComponent(table, value, isSelected, hasFocus, row c.setBorder(new EmptyBorder(2,2,2,2)); 
return c; } }
...
JLabel bid_l, bname_l, pub_l, pubdate_l, categ_l, no_of_copy_l; JTextField bid_t, bname_t, pub_t, pubdate_t, categ_t, no_of_copy_t; 
int flag = 0; 
Label error; 
JPanel return_book; 
...
panel_login = new JPanel(); panel_login.setSize(500, 500); panel_login.setLocation(166, 70); panel_login.setVisible(true); 
panel_login.setBackground(new Color(62, 64, 69)); 
labeluser = new JLabel("Username"); labeluser.setBounds(150, 70, 120, 25); 
labeluser.setForeground(Color.WHITE); 
labeluser.setFont(new Font("Century Gothic", Font.BOLD, 13)); panel_login.add(labeluser); 
userField = new JTextField(); userField.setBounds(150, 100, 200, 30); userField.setHorizontalAlignment(JTextField.CENTER); 
userField.setBorder(null); 
panel_login.add(userField); 
labelpwd = new JLabel("Password"); labelpwd.setBounds(150, 138, 80, 25); 
labelpwd.setForeground(Color.WHITE); 
labelpwd.setFont(new Font("Century Gothic", Font.BOLD, 13)); panel_login.add(labelpwd); 
pwdField = new JPasswordField(); pwdField.setBounds(150, 165, 200, 30); pwdField.setHorizontalAlignment(JTextField.CENTER); 
...
background = new JPanel(); background.setSize(850, 500); background.setVisible(false); 
...
newŠtudent.setFocusPainted(false); 
issueBook = new JButton("Issue Book"); issueBook.addActionListener(this); 
issueBook.setBounds(340, 20, 150, 30); background.add(issueBook); issueBook.setFocusPainted(false); 
...
stu_l.setBounds(90, 85, 200, 30); stud_form.add(stu_l); 
...
stubrn_l = new JLabel("Branch"); stubrn_l.setBounds(108, 169, 200, 30); stud_form.add(stubrn_l); 
...
save_login = new JButton("Save"); save_login.addActionListener(this); save_login.setBounds(315, 211, 75, 30); save_login.setFocus Painted(false); stud_form.add(save_login); 
background.add(stud_form); 
issue_book = new JPanel(); issue_book.setSize(500, 350); 
...
new_book = new JPanel(); new_book.setSize(500, 350); new_book.setLocation(166, 72); 
new_book.setVisible(false); 
new_book.setLayout(null); 
new_book.setBackground(new Color(62, 64, 69)); 
newBook = new JButton("New Book"); newBook.addActionListener(this); newBook.setBounds(180, 20, 150, 30); background.add(newBook); newBook.setFocusPainted(false);
bid = new JLabel("Book ID"); bid_l.setBounds(102, 35, 200, 30); new_book.add(bid_l); 
bid_T.setForeground(Color.WHITE); 
bid_l.setFont(new Font("Century Gothic", Font.BOLD, 12)); 
bid_t = new JTextField(); bid_t.setBounds(190, 35, 200, 30); bid_t.setHorizontalAlignment(JTextField.CENTER); 
bid_t.setBorder(null); new_book.add(bid_t); 
...
bname_t = new JTextField(); bname_t.setBounds(190, 77, 200, 30); bname_t.setHorizontalAlignment(JTextField.CENTER); 
bname_t.setBorder(null); 
new_book.add(bname_t); 
pub_l = new JLabel("Publisher"); pub_l.setBounds(98, 119, 200, 30); new_book.add(pub_l); 
pub_l.setForeground(Color.WHITE); 
pub_l.setFont(new Font("Century Gothic", Font.BOLD, 12)); 
pub_t = new JTextField(); pub_t.setBounds(190, 119, 200, 30); pub_t.setHorizontalAlignment(TextField.CENTER); 
pub_t.setBorder(null); 
new_book.add(pub_t); 
pubdate_l = new JLabel("Published Date"); pubdate_l.setBounds(63, 161, 200, 30); 
new_book.add(pubdate_l); 
pubdate_l.setForeground(Color.WHITE); 
pubdate_l.setFont(new Font("Century Gothic", Font.BOLD, 12)); 
pubdate_t = new JTextField(); pubdate_t.setBounds(190, 161, 200, 30); 
...
no_of_copy_l = new JLabel("No. of Copies"); no_of_copy_l.setBounds(72, 245, 200, 30); 
new_book.add(no_of_copy_l); 
no_of_copy_l.setForeground(Color.WHITE); 
no_of_copy_l.setFont(new Font("Century Gothic", Font.BOLD, 12)); 
no_of_copy_t = new JTextField(); no_of_copy_t.setBounds(190, 245, 200, 30); 
...
save_book.setFocus Painted(false); 
new_book.add(save_book); 
background.add(new_book); 
error = new JLabel("Login Unsuccessful!!!"); error.setBounds(190, 275, 200, 30); 
error.setForeground(Color.GRAY); error.setVisible(false); 
...
returnBook = new JButton("Return Book"); returnBook.addActionListener(this); returnBook.setBounds(500, 20, 150, 30); background.add(returnBook); returnBook.setFocusPainted(false); 
sturet_! = new JLabel("Student ID"); sturet_l.setBounds(90, 85, 200, 30); return_book.add(sturet_l); 
...
bookret_l = new JLabel("Book ID"); bookret_l.setBounds(103, 127, 200, 30); 
...
return_l = new JLabel("Return Date"); return_l.setBounds(81, 169, 200, 30); return_book.add(return_l); 
...
login.setContentArea Filled(false); 
...
newBook.setBorder Painted(false); 
newBook.setContentArea Filled(false); 
...
issueBook.setBorder Painted(false); 
issueBook.setContentArea Filled(false); 
...
returnBook.setContentArea Filled(false); 
...
statistics.setContentArea Filled(false); 
...
save_login.setBorder Painted(false); 
save_login.setContentArea Filled(false); 
...
save_book.setContentArea Filled(false); 
...
issue.setContentArea Filled(false); 
...
returnbtn.setContentArea Filled(false); 
...
break; 
if (flag=== 0) { error.setVisible(true); 
...
return_book.setVisible(false); 
stati.setVisible(false); 
issueBook.setBackground(new Color(209, 54, 15)); newBook.setBackground(new Color(58, 63, 156)); newStudent.setBackground(new Color(58, 63, 156)); returnBook.setBackground(new Color(58, 63, 156)); statistics.setBackground(new Color(58, 63, 156));
Date date = Calendar.getInstance().getTime(); 
DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd"); issuedate_tString = dateFormat.format(date); issuedate_t.setText(issuedate_tString); 
...
String url = "jdbc:mysql://localhost:3306/library"; 
Class.forName("com.mysql.cj.jdbc.Driver"); 
conn = DriverManager.getConnection(url, userName, password); stmt = conn.createŠtatement(); 
...
return_book.setVisible(false); 
stati.setVisible(false); 
newStudent.setBackground(new Color(209, 54, 15)); newBook.setBackground(new Color(58, 63, 156)); issueBook.setBackground(new Color(58, 63, 156)); returnBook.setBackground(new Color(58, 63, 156)); statistics.setBackground(new Color(58, 63, 156)); 
...
System.out.println("SQLException: " + ex.getMessage()); } catch (Exception b) { 
System.out.print(b.getMessage());
System.err.println("Cannot connect to database server"); 
} finally { 
if (rs != null) { 
...
issueBook.setBackground(new Color(58, 63, 156)); 
returnBook.setBackground(new Color(58, 63, 156)); statistics.setBackground(new Color(58, 63, 156)); 
...
System.out.println("Inserted Succesfully"); 
bid_t.setText(""); 
bname_t.setText(""); pub_t.setText("");` 
pubdate_t.setText("'"); 
categ_t.setText(""); no_of_copy_t.setText(""); 
} catch (SQLException ex) { 
...
stati.setVisible(false); 
returnBook.setBackground(new Color(209, 54, 15)); newStudent.setBackground(new Color(58, 63, 156)); issueBook.setBackground(new Color(58, 63, 156)); newBook.setBackground(new Color(58, 63, 156)); statistics.setBackground(new Color(58, 63, 156)); 
Date date = Calendar.getInstance().getTime(); 
DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd"); return_tString = dateFormat.format(date); 
...
if (bookret_tString.equals(temp_bookid) && sturet_tString.equals(temp_stu_id)) { String sql = "delete from book_issue where Student_ID=" + sturet_tString + ";"; stmt.executeUpdate(sql); 
...
while (rs.next()) { 
String temp_bookid = rs.getString("Book_ID"); String temp_bookname=rs.getString("Book_name"); String category=rs.getString("Category"); 
String avail-rs.getString("Availability"); 
x.add(new ArrayList<String>(Arrays.asList(temp_bookid,temp_bookname,category,avail))); 
for(int i = 0; i < x.size(); i++){ 
for(int j = 0; j <x.get(i).size(); j++){ System.out.print(x.get(i).get(j)); 
System.out.println(); 
String str[][]=new String[x.size()][4]; for(int i = 0; i < x.size(); i++){ 
} 
} 
...
j.setEnabled(false); 
j.setBounds(25,25,700,350); sp = new JScrollPane(); sp.setBounds(45,25,700,350); 
stati.add(sp); 
sp.getViewport().setBackground(new Color(62, 64, 69)); 
sp.setBorder(null); 
j.setBackground(new Color(62, 64, 69)); j.setForeground(Color.WHITE); 
...
TableCellRenderer baseRenderer = j.getTableHeader().getDefaultRenderer(); j.getTableHeader().setDefaultRenderer(new TableHeaderRenderer(baseRenderer)); 
